...
if __name__ == '__main__':
    ...
    threshold = 0.012 # Adjust the threshold factor based on your needs
    ...
    hand_movements = threshold_segmentation_with_window(data, threshold, window_size,ignore_after=9000)
